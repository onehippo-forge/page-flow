...
public class NewsDocument extends HippoDocument {
     ...
     */
    public final static String DOCUMENT_TYPE = "pageflowdemo:newsdocument";

    private final static String TITLE = "pageflowdemo:title";
    private final static String DATE = "pageflowdemo:date";
    private final static String INTRODUCTION = "pageflowdemo:introduction";
    private final static String IMAGE = "pageflowdemo:image";
    private final static String CONTENT = "pageflowdemo:content";
    private final static String LOCATION = "pageflowdemo:location";
    private final static String AUTHOR = "pageflowdemo:author";
    private final static String SOURCE = "pageflowdemo:source";
